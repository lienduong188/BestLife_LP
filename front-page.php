	...
	<div class="<?php lightning_the_class_name( 'site-body-container' ); ?> container">
		...
		<div class="<?php lightning_the_class_name( 'main-section' ); ?>" id="main" role="main">
			...
			<?php 
				...
				get_template_part("template/contents", "bestlife");
				get_template_part("template/contents", "flow");
				get_template_part("template/contents", "strengths");
				
				get_template_part("template/contents", "faq");
				get_template_part("template/contents", "about");
